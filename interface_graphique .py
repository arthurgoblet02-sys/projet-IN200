...
def button_play():
    bouton_play.destroy()
    bouton_moins_10.grid(row=2, column=20, ipadx=10, ipady=5)
    bouton_moins_1.grid(row=2, column=25, padx=10, ipadx=10, ipady=5)
    bouton_moins_0_25.grid(row=2, column=30, ipadx=10, ipady=5)
    texte_vitesse.grid(row=1, column=35, ipadx=10, ipady=5, padx=10)
    bouton_reset.grid(row=2, column=35, padx=10, ipadx=10, ipady=5)
    bouton_plus_0_25.grid(row=2, column=40, ipadx=10, ipady=5)
    bouton_plus_1.grid(row=2, column=45, padx=10, ipadx=10, ipady=5)
    bouton_plus_10.grid(row=2, column=50, ipadx=10, ipady=5)
